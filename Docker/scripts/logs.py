...
class LogParser:
    def __init__(self, clients, primaries, workers, faults=0):
        ...
        try:
            ...
            for client in clients:
                results.append(self._parse_clients(client))
        ...
        try:
            for primary in primaries:
                results.append(self._parse_primaries(primary))
            # with Pool() as p:
        ...
        try:
            ...
            for worker in workers:
                results.append(self._parse_workers(worker))
        except (ValueError, IndexError, AttributeError) as e:
            exception(e)
    ...
    def _parse_primaries(self, log):
        ...
        # ip = search(r'booted on (/dns/\d+.\d+.\d+.\d+)', log).group(1)
        ip = '/dns/primary_0/tcp/3000/http'
